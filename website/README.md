...
- Styling with [Tailwind](https://tailwindcss.com/) REMOVED
...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create website-6554
  fly apps create website-6554-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app website-6554
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app website-6554-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'website-6554-staging' does not match app name in config file 'website-6554'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name website-6554-db
  fly postgres attach --app website-6554 website-6554-db

  fly postgres create --name website-6554-staging-db
  fly postgres attach --app website-6554-staging website-6554-staging-db
  ```
